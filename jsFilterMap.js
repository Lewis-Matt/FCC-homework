...
// Filter the list to only have ratings > 8.0 (must convert string to float)
const highRatings = watchList.filter(rating => parseFloat(rating.imdbRating) > 8.0);
// Debug
console.log(highRatings);
// Map the list of highRatings to a new array with two keys
const filteredList = highRatings.map(movie => ({
  title: movie["Title"],
